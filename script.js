...
const THREAD_CATALOG = [
    {
        ...
        title: 'Cyprus Cross-Border Watch: Pillar Two, Vietnam Treaty and FDI Screening',
        excerpt: 'A practical international update covering the official June 2026 minimum effective global taxation notices, the Cyprus-Vietnam treaty signing, OECD/G20 coordination and the FDI screening framework now in force.',
    ...
    },
    {
        ...
        title: 'Cyprus Tax Calendar 2026: PAYE, Personal Returns, VAT and Provisional Tax Dates',
        excerpt: 'A dated compliance map of the 2026 filing points that matter most, including the July 20, 2026 VIES extension, annual PAYE 2025 deadline and provisional tax dates.',
        href: 'thread-filing-penalties-calendar.html',
        summary: 'Deadline briefing: employer PAYE, VIES/VAT notices, personal return deadline monitoring, provisional tax installments, and where to recheck official notices.',
        sources: 8,
        updated: 'August 17, 2026',
        updatedIso: '2026-08-17',
        cta: 'View Dates',
    ...
    },
    {
        ...
        title: 'VAT Operating Notes 2026: Zero-Rate Goods, Housing VAT and SME Scheme Checks',
        excerpt: 'A VAT operations briefing on temporary zero-rate windows, qualifying meat and fish through September 30, 2026, period-specific VAT/VIES extensions, housing VAT and SME checks.',
        href: 'thread-vat-zero-rate-exit-readiness.html',
        summary: 'VAT operations note on zero-rate controls, meat and fish relief, VAT/VIES notices, primary-residence VAT transition, SME checks and transition planning.',
        sources: 7,
        updated: 'August 17, 2026',
        updatedIso: '2026-08-17',
        cta: 'Read VAT Note',
    ...
    },
    {
        ...
        excerpt: 'A corporate briefing on the Cyprus reform package effective from January 1, 2026, with the 15% corporation tax rate, CY Login registry routing, TFA document stamping and governance.',
        href: 'thread-corporate-tax-transition.html',
        summary: 'Corporate reform note on the new 15% income tax rate, CY Login, document stamping and governance steps for 2026 close cycles.',
        sources: 4,
        updated: 'August 17, 2026',
        updatedIso: '2026-08-17',
    ...
    },
    {
        ...
        excerpt: 'A practical map of the published 2025 return trigger, residency tests, TAXISnet-to-Tax For All transition and document controls that prevent avoidable compliance misses.',
        ...
        keywordChips: ['Cyprus filing obligation 2026', 'Cyprus individual return deadline 2026']
    },
    {
        id: 'crypto-framework',
        primary: false,
    ...
    },
    {
        ...
        title: 'Housing, Rent Payments and TD59 Support: What Payroll Files Should Keep',
        excerpt: 'A working checklist for taxpayers and payroll teams tracking child deductions, housing loan interest, electronic rent-payment evidence and other TD59-linked claims under the 2026 package.',
...
function calculateSalary() {
    ...
    // Employee SI: 8.8% up to the 2026 annual cap | GESY: 2.65% on gross
    const annualSocialInsuranceCap = 68904;
...
function initCalendar() {
    const deadlines = [
        ...
        { date: "2026-09-30", title: "Annual PAYE withholding return for 2025" },
