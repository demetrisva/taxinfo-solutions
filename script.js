...
const THREAD_CATALOG = [
    {
        ...
        title: 'Cyprus Cross-Border Tax Watch: Vietnam Treaty and OECD Side-by-Side Package',
        excerpt: 'A practical update on the Cyprus-Vietnam treaty signed on December 15, 2025 and the Ministry of Finance January 8, 2026 note on the OECD/G20 BEPS side-by-side package.',
    ...
    },
    {
        ...
        excerpt: 'A dated compliance map of the 2026 filing points that matter most, including the Tax For All payroll extensions announced in January 2026 and the provisional tax cycle.',
    ...
    },
    {
        ...
        title: 'VAT Zero-Rate Exit Runway 2026: Q4 Controls Before the 2027 Reset',
        excerpt: 'A practical operations briefing for businesses using the temporary zero-rate basic goods window through December 31, 2026, with SKU, invoice and pricing controls before the January reset.',
        href: 'thread-vat-zero-rate-exit-readiness.html',
        summary: 'VAT operations briefing on zero-rate period controls, Q4 preparation, and January 2027 reset readiness.',
        sources: 3,
        updated: 'Mar 21, 2026',
        updatedIso: '2026-03-21',
        cta: 'Read VAT Briefing',
    ...
    },
    {
        ...
        title: 'Tax For All Payroll Guide: Monthly Withholding, TD59 and 2026 Rechecks',
        excerpt: 'A payroll-focused briefing on what changed under Tax For All, how the 2026 personal tax reform interacts with employer withholding, and where TD59 deductions fit into year-round controls.',
    ...
    },
    {
        ...
        tag: 'Corporate',
        kicker: 'Core Reform',
        title: 'Corporate Tax Reform 2026: 15% Rate, Effective Dates and Finance Team Checklist',
        excerpt: 'A corporate briefing on the Cyprus income tax reform package effective from January 1, 2026, with emphasis on year-end close, forecasting, board papers and policy updates.',
    ...
    },
    {
        ...
        excerpt: 'This briefing focuses on the reduced 5% Special Defence Contribution rate on dividends from January 1, 2026 and the questions shareholders should document before declaring distributions.',
    ...
    },
    {
        ...
        title: '2026 Salary Tax Reform: EUR 22,000 Threshold, New Bands and Filing Duty',
        excerpt: 'A plain-English guide to the Cyprus personal income tax reform effective January 1, 2026, including the new tax-free threshold, updated progressive bands and the broadened filing obligation.',
    ...
    },
    {
        ...
        title: 'Crypto Gains at 8%: Cyprus Recordkeeping, Disposal Timing and Evidence Rules',
        excerpt: 'A compliance-first briefing on the 8% tax treatment for gains from disposal of crypto assets under the January 2026 tax incentives package, with a stronger focus on evidence than marketing headlines.',
    ...
    },
    {
        ...
        title: 'Housing, Children and Green Deductions: What to Keep for TD59 Support',
        excerpt: 'A working checklist for taxpayers and payroll teams tracking the support behind child deductions, housing loan interest, rent and green-upgrade claims under the 2026 reform package.',
    ...
    },
    {
        ...
        title: 'Qualified Stock Options at 8%: Approval Windows, Vesting Files and Startup Controls',
        excerpt: 'A founder and finance-team guide to the new 8% tax treatment for approved employer incentive schemes, including the special June 30, 2026 approval window for older plans.',
...
function renderForumStatsFromCatalog() {
    ...
    const totalReplies = THREAD_CATALOG.reduce((sum, thread) => sum + (thread.sources || 0), 0);
...
function calculateBusiness() {
    ...
    if (diff > 0) {
        verdictDiv.innerText = `This simple reform scenario shows €${formatMoney(diff)} more net cash than the 2025 baseline.`;
        verdictDiv.classList.add('verdict-positive');
    } else if (diff < 0) {
        verdictDiv.innerText = `This simple reform scenario shows €${formatMoney(Math.abs(diff))} less net cash than the 2025 baseline.`;
        verdictDiv.classList.add('verdict-negative');
    } else {
        verdictDiv.innerText = "No net difference between the 2025 baseline and this simplified 2026 reform scenario.";
...
function renderThreadDirectory() {
    ...
    const sortedThreads = [...THREAD_CATALOG].sort((a, b) => new Date(b.updatedIso) - new Date(a.updatedIso) || b.sources - a.sources);
