console.log("TaxInfo editorial site loaded");
...
const THREAD_CATALOG = [
    {
        ...
        title: 'Cyprus Cross-Border Watch: Vietnam Treaty, BEPS Package and FDI Screening',
        excerpt: 'A current international briefing covering the Cyprus-Vietnam treaty signed on December 15, 2025, the January 8, 2026 BEPS package note, and the FDI screening framework entering into force on April 2, 2026.',
        href: 'thread-transfer-pricing-playbook.html',
        summary: 'International desk note on treaty expansion, BEPS monitoring, and the new FDI screening framework.',
        sources: 3,
        updated: 'Mar 28, 2026',
        updatedIso: '2026-03-28',
        cta: 'Read Briefing',
        gradient: 'linear-gradient(135deg, #0c5c7a, #2ca58d)',
        keywordChips: ['Cyprus Vietnam double tax treaty', 'Cyprus OECD BEPS side-by-side package', 'Cyprus FDI screening April 2026']
    },
    {
        id: 'filing-calendar',
        categoryKey: 'payroll',
        ...
        excerpt: 'A dated compliance map of the 2026 filing points that matter most, including the current Tax For All PAYE deadlines and the provisional tax cycle.',
    ...
    },
    {
        ...
        excerpt: 'A practical VAT briefing on the temporary zero-rate basic goods window through December 31, 2026 and the small-enterprise regime that took effect from January 1, 2025.',
        href: 'thread-vat-zero-rate-exit-readiness.html',
        summary: 'VAT operations briefing on zero-rate controls, SME scheme checks, and year-end transition planning.',
        sources: 3,
        updated: 'Mar 28, 2026',
        updatedIso: '2026-03-28',
        cta: 'Read VAT Note',
    ...
    },
    {
        ...
        title: 'Tax For All Payroll Guide: Monthly Withholding, TD59 and March Rechecks',
        excerpt: 'A payroll-focused briefing on the current Tax For All filing dates, the interaction with 2026 personal tax changes, and where TD59 support fits into year-round controls.',
    ...
    },
    {
        ...
        excerpt: 'A corporate briefing on the Cyprus income tax reform package effective from January 1, 2026, with emphasis on 15% corporation tax, close processes, forecasts and governance.',
    ...
    },
    {
        ...
        title: '2026 Salary Tax Reform: EUR 22,000 Threshold, New Bands and Filing Scope',
        excerpt: 'A practical guide to the Cyprus personal income tax reform effective from January 1, 2026, including the EUR 22,000 tax-free threshold, updated bands and broader filing scope.',
    ...
    },
    {
        ...
        excerpt: 'A compliance-first briefing on the 8% tax treatment for gains from disposal of crypto assets under the January 2026 tax incentives package, with a stronger focus on evidence than headlines.',
    ...
    },
    {
        ...
        excerpt: 'A working checklist for taxpayers and payroll teams tracking the support behind child deductions, housing loan interest, rent and other TD59-linked claims under the 2026 reform package.',
...
function calculateSalary() {
    ...
    if (year === '2026') {
        ...
        if (noteElement) {
            noteElement.innerText = "*Calculated with the 2026 published brackets plus estimator assumptions for employee SI and GESY. Check deductions and filing facts before relying on the result.";
        }
    } else {
...
function calculateBusiness() {
    ...
    if (diff > 0) {
        verdictDiv.innerText = `This simple comparison shows €${formatMoney(diff)} more post-tax cash than the 2025 baseline. It assumes a Cyprus-domiciled shareholder and no special exemptions.`;
        verdictDiv.classList.add('verdict-positive');
    } else if (diff < 0) {
        verdictDiv.innerText = `This simple comparison shows €${formatMoney(Math.abs(diff))} less post-tax cash than the 2025 baseline. It assumes a Cyprus-domiciled shareholder and no special exemptions.`;
